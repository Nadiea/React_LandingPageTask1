...
export default function Howtocreate() {
  return (
    <div className=" bg-[#131A2C]">
      ...
      <div className="relative w-full bg-[#131A2C] pt-[40px] lg:pt-[100px] mt-10">
        <div className="custom-container">
          <div className="mb-[50px] w-full text-left lg:text-center">
            ...
            <p className="font-inter mx-auto w-[335px] text-[16px] text-white/[0.7] lg:w-[665px] lg:text-[18px]">
              ...
              passion for creativity, fostering a limitless realm of
              imagination.
            </p>
          </div>
          <div className="flex w-[80%] mx-auto  flex-col gap-[32px] px-[20px] lg:flex-row lg:px-0">
            <div className="relative  h-[200px] w-full lg:h-[509px] lg:w-[306px]">
              <div className="absolute left-[90%] top-0 translate-x-0 lg:-top-[56px] lg:left-[50%] lg:-translate-x-[50%]">
                <p className="header-font text-[56px] font-medium leading-[56px] text-white/[0.1]">
                  1
                </p>
              </div>
              <div className="absolute left-0 top-0 w-full">
                <div>
                  <div className="mb-[12px] w-full lg:mb-[32px]">
                    <svg
                  ...
                  <div className="-translate-[66px] absolute left-[66px] top-[33px] hidden h-[66px] w-full rounded-tr-lg border-r-2 border-t-2  border-dashed border-white/[0.4] lg:block "></div>
                  <p className="header-font text-[24px] font-[500] leading-[38px] text-white lg:text-[32px]">
                    Create account
                  </p>
                  <p className="font-inter mt-[8px] text-[16px] font-[400] leading-[20px] text-white/[0.6] lg:mt-[16px]">
                    To create an account on Mazala.AI, the platform for
                    unleashing your creativity and exploring the depths of
                    imagination
                  </p>
                </div>
              </div>
            ...
            <div className="relative  h-[200px] w-full lg:h-[509px] lg:w-[306px]">
              <div className="-translate-[0%] lg:-translate-[50%] absolute left-[90%] top-0 lg:left-[50%] lg:top-[5%]">
                <p className="header-font text-[56px] font-medium leading-[56px] text-white/[0.1]">
                  2
                </p>
              </div>
              <div className="absolute left-0 top-0 lg:top-[15%]">
                <div>
                  <div className="mb-[12px] lg:mb-[32px]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="66"
                      height="66"
                  ...
                  <p className="font-inter mt-[8px] text-[16px] leading-[20px] text-white/[0.6] lg:mt-[16px]">
                    After signing up on Mazala.AI, delve into various creative
                    tools to spark inspiration and realization.
                  </p>
                </div>
              </div>
            </div>
            <div className="relative  h-[200px] w-full lg:h-[509px] lg:w-[306px]">
              <div className="absolute left-[90%] top-0 translate-x-0 lg:left-[50%] lg:top-[20%] lg:-translate-x-[50%]">
                <p className="header-font text-[56px] font-medium leading-[56px] text-white/[0.1]">
                  3
                </p>
              </div>
              <div className="absolute left-0 top-0 lg:top-[30%]">
                <div>
                  <div className="mb-[12px] lg:mb-[32px]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="relative  h-[200px] w-full lg:h-[509px] lg:w-[306px]">
              <div className="absolute left-[90%] top-0 translate-x-0 lg:left-[50%] lg:top-[45%] lg:-translate-x-[50%]">
                <p className="header-font text-[56px] font-medium leading-[56px] text-white/[0.1]">
                  4
                </p>
              </div>
              <div className="absolute left-0 top-0 lg:top-[45%]">
                <div>
                  <div className="mb-[12px] lg:mb-[32px]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      ...
                      className="hidden lg:block"
                    >
                      <circle cx="33" cy="33" r="33" fill="#59CA00"></circle>
                      <path
                        d="M43.1699 15H22.8338C21.0416 15 19.5195 16.4455 19.5195 18.3143V48.3845C19.5248 50.7566 22.4221 51.8696 24.0692 50.2045L31.8207 42.4551C32.4419 41.8071 33.5618 41.8071 34.183 42.4551L41.9345 50.2045C43.5824 51.8702 46.4793 50.7555 46.4842 48.3845V18.3143C46.4842 16.4455 44.9621 15 43.1699 15Z"
                        fill="white"
                      ></path>
                    </svg>
                    <svg
                  ...
                  <p className="font-inter mt-[8px] text-[16px] leading-[20px] text-white/[0.6] lg:mt-[16px]">
                    Preserve your creations and spread inspiration by easily
                    saving and sharing your imaginative endeavors.
                  </p>
                </div>
              </div>
            </div>
